...
func tweenPos()->void:
	...
	tween.tween_property(effect,"position",Vector2(320,47),4.5 * 2)
	tween.tween_property(effect2,"position",Vector2(0,47),4.5 * 2)
	if effect.visible:
		tween.tween_callback(tweenPos).set_delay(4.5 * 2)
